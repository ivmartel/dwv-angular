...
export class DwvComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.0", ngImport: i0, type: DwvComponent, deps: [{ token: i1.MatDialog }], target: i0.ɵɵFactoryTarget.Component });
